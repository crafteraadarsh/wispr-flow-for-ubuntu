...
declare -gA MARKER_SAMPLES=(
	...
	[pilldrag]='re=e=>{let t,n;e=(/*WISPR_LINUX_DISABLE_PILL_DRAG*/"linux"===process.platform)?!1:e;if(a().info(`x`),U=e,e){}}'
...
@test "verify: exits 1 when the pill-drag marker is missing" {
	local fixture
...
@test "verify: exits 1 when the status-compact marker is missing" {
	local fixture
...
@test "verify: exits 1 when the status-screenpos marker is missing" {
	local fixture
